...
// import { ClientNav } from "@/components/navigations/client-nav";
...
//           <Link href="/cuisine" className="hover:text-gray-400">
//             Cuisines
//           </Link>
...
//         <li>
//           <Link href="/meal-plan" className="hover:text-gray-400">
//             Meal Plans
//           </Link>
//         </li>
...
// components/navigations/main-navigation.tsx
import Link from "next/link";
import Image from "next/image";
import { getCuisine } from "@/components/prisma-db";
import { ClientNav } from "@/components/navigations/client-nav";
